 ...
 <section class="page-section">
        <div class="container">
            <div class="product-item">
                ...
                </div><img alt='not available'  class="img-fluid d-flex mx-auto product-item-img mb-3 mb-lg-0 rounded" src="assets/img/products-01.jpg"/>
    ...
    <section class="page-section">
        <div class="container">
            <div class="product-item">
                ...
                </div><img alt='not available' class="img-fluid d-flex mx-auto product-item-img mb-3 mb-lg-0 rounded" src="assets/img/products-02.jpg"/>
                <div class="bg-faded p-5 rounded">
    ...
    <section class="page-section">
        <div class="container">
            <div class="product-item">
                ...
                </div><img alt='not available' class="img-fluid d-flex mx-auto product-item-img mb-3 mb-lg-0 rounded" src="assets/img/products-03.jpg"/>
                <div class="bg-faded p-5 rounded">
